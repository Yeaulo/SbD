  ...
  function getMeasurements(smartmeter_id) {
    ...
    const fetchData = async () => {
      try {
        ...
        const lastvalue =
          smartmeterListMeasurments[smartmeterListMeasurments.length - 1].value;
    ...
    <div className="smartmeter-container">
      <div className="smartmeter-outer-left">
        <div className="smartmeter-inner-top">
          <div className="smartmeter-inner-left_top_left">
            <p className="smartmeter-header-text-center">
          ...
          <div className="smartmeter-contract-data">
            ...
            >
              <div className="group1">
                <div className="smartmeter-contract-data-properties">
      ...
      <div className="smartmeter-outer-right">
        <div className="smartmeter-electricity-data">
          <div className="smartmeter-heading-right-title">
            Stromzählerinformationen
          </div>
        </div>
        <div className="smartmeter-inner-right">
          <div className="smartmeter-data-container">
            ...
            <p className="smartmeter-data-text">
              Zählernummer: {smartmeter_id}{" "}
            </p>
            ...
            <p className="smartmeter-data-text">
              Straße/Nr: {address} {house_number}
            </p>
